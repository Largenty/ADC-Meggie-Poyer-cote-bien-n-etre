...
//  (rich results Google). Réponses en texte simple.
// ============================================================
...
export const faq = [
  ...
  },
  {
    ...
    answer:
      "Le shiatsu se pratique habillé : des pressions le long des méridiens pour rééquilibrer l'énergie et relâcher les tensions profondes. Le massage bien-être est un modelage enveloppant du corps. Sur place, je m'appuie sur l'un, l'autre, ou les deux.",
  },
  {
    question: "Qu'est-ce que la Technique MEBP® ?",
    answer:
      "La Technique MEBP® (Massage pour Enfants à Besoins Particuliers) est une méthode certifiée pensée pour le confort et l'apaisement des enfants à besoins particuliers : autisme, TDAH, anxiété, troubles sensoriels. Le massage se pratique habillé, allongé, avec des gestes lents. Je suis praticienne certifiée MEBP®.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Le plus simple est de réserver en ligne via Resalib, depuis le bouton « Réserver » du site. Vous pouvez aussi me contacter par téléphone ou via le formulaire de contact.",
  },
  {
    question: 'Quels sont les tarifs ?',
    answer:
      "Massage bien-être 1 h : 65 €, séance de shiatsu : 70 €, massage femme enceinte : 70 €. Le détail figure sur la page Tarifs. Des bons cadeaux et des forfaits sont possibles.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Oui. Vous choisissez la prestation, vous remplissez le formulaire de contact, puis je prépare le bon : remis en mains propres au cabinet ou envoyé par e-mail ou courrier après paiement.",
  },
];
